# 1 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c"
...
# 1 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
...
# 2 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
...
# 3 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
...
vuser_init()
{
    ...
    lr_save_string(transactionName, "transactionName");
  	...
  	sprintf(body,
    	...
    	"    \"slaGroupList\": [\n"
    	"      {\"type\":\"GENERAL_TEST_SLA\",\"targetType\":\"TEST\",\"slaList\":[{\"fromDate\":6,\"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":46,\"value\":\"15\"},{\"fromDate\":10,\"restrictionType\":\"ERROR_RATE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":53,\"value\":\"5\"}]},\n"
    	"      {\"type\":\"THREAD_GROUP_SLA\",\"targetType\":\"THREAD_GROUP\",\"slaList\":[{\"fromDate\":4,\"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":20,\"value\":\"45\"}],\"threadGroupId\":\"2e6ba5cb-5c2c-4df6-bd3e-8d7a1ed15cc3\",\"threadGroupName\":\"random_test\"},\n"
    	"      {\"type\":\"TRANSACTION_SLA\",\"targetType\":\"TRANSACTION\",\"transactionId\":\"ab427d86-711c-49dd-b889-7ae727e22e53\",\"transactionName\":\"random_transaction_666\",\"slaList\":[{\"fromDate\":13,\"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":51,\"value\":\"6\"}],\"threadGroupId\":null,\"threadGroupName\":null},\n"
    	"      {\"type\":\"REQUEST_SLA\",\"targetType\":\"REQUEST\",\"transactionFilterType\":\"ANY_TRANSACTION\",\"requestName\":\"https://webtours.pflb.ru/WebTours/\",\"slaList\":[{\"fromDate\":8,\"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":53,\"value\":\"7\"}],\"threadGroupId\":null,\"threadGroupName\":null}\n"
    	"    ],\n"
    	"    \"supportingFiles\":[],\n"
    	"    \"supportingFilesV2\":[]\n"
    	"  },\n"
...
# 4 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
...
Action()
{
	...
	lr_end_transaction("UC_03_TR_02_create_test",2);

	return 0;
}
# 5 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
...
# 6 "c:\\users\\vinny\\desktop\\project scripts\\uc_03_createtest\\\\combined_UC_03_CreateTest.c" 2
