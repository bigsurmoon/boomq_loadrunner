vuser_init()
{
    ...
    lr_save_string(transactionName, "transactionName");
  	...
  	sprintf(body,
    	...
    	"      {\"type\":\"THREAD_GROUP_SLA\",\"targetType\":\"THREAD_GROUP\",\"slaList\":[{\"fromDate\":4,\"restrictionType\":\"AVERAGE\",\"operation\":\"LESS_EQUALS\",\"status\":\"NOT_COUNTED\",\"toDate\":20,\"value\":\"5\"}],\"threadGroupId\":\"2e6ba5cb-5c2c-4df6-bd3e-8d7a1ed15cc3\",\"threadGroupName\":\"random_test\"},\n"
