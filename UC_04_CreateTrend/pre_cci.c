# 1 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c"
...
# 1 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
...
# 2 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
...
# 3 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
...
# 4 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
...
Action()
{
	...
	lr_end_transaction("UC_04_TR_01_sign_in",2);
	...
	lr_end_transaction("UC_04_TR_02_click_trending_button",2);
	...
	lr_end_transaction("UC_04_TR_03_add_new_trend_report", 2);
	...
	lr_end_transaction("UC_04_TR_04_select_test",2);
	...
	lr_end_transaction("UC_04_TR_05_click_next",2);
	...
	lr_end_transaction("UC_04_TR_06_add_items",2);
	...
	lr_end_transaction("UC_04_TR_07_save",2);
	
	} else {
		lr_output_message("Ќедостаточно тестов: запусков меньше двух.");
	}

	lr_end_transaction("UC_04_TR_GLOBAL",2);
	
	return 0;
}
# 5 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
...
# 6 "c:\\users\\vinny\\desktop\\project scripts\\uc_04_createtrend\\\\combined_UC_04_CreateTrend.c" 2
